...
class DustSoftUI:
    ...
    def __init__(self, app: Application) -> None:
        ...
        self.compressor_safe_var = tk.StringVar(value=str(relays.compressor.safe_level))
        self.valve_pin_var = tk.StringVar(value=str(relays.valve.pin_bcm))
        self.valve_active_var = tk.StringVar(value=str(relays.valve.active_level))
        self.valve_safe_var = tk.StringVar(value=str(relays.valve.safe_level))
    ...
    def _build_hardware_screen(self) -> None:
        ...
        ttk.Label(mapping_frame, text="Заметка").grid(row=0, column=0, sticky="w", pady=4)
        ...
        rows = [
            ...
            ("Valve relay BCM", self.valve_pin_var),
            ("Valve active level", self.valve_active_var),
            ("Valve safe level", self.valve_safe_var),
        ]
        ...
        ).grid(row=len(rows) + 1, column=0, columnspan=2, sticky="ew", pady=(12, 0))
